    ...
    <main className="campaign-v2">
      ...
      <section className="campaign-v2-hero">
        <div className="campaign-v2-hero-copy">
          <p className="eyebrow">A situação exige atenção</p>
          <h1>Sua conta foi utilizada para receber ou transferir dinheiro relacionado a um golpe?</h1>
          <p>Isso pode resultar em investigação criminal, bloqueio de valores e acusações como estelionato ou lavagem de dinheiro.</p>
          ...
          <small>Atendimento jurídico para clientes de Cuiabá, Várzea Grande e Rondonópolis — MT</small>
        </div>
      ...
      <section className="campaign-v2-lawyer">
        ...
        <div><p className="eyebrow light">Atendimento jurídico individualizado</p><h2>Uma análise cuidadosa para compreender o seu caso.</h2><p>Junqueira de Miranda Advocacia atua na análise de investigações e processos criminais relacionados à utilização de contas bancárias por terceiros.</p><p>O atendimento inicial busca identificar a fase do caso, possíveis prazos e os documentos necessários para análise.</p><strong>Junqueira de Miranda Advocacia<br /><span>OAB/MT 29.103-O</span></strong><small>Atendimento jurídico para clientes de Cuiabá, Várzea Grande e Rondonópolis — MT</small></div>
      </section>

      <section className="campaign-v2-form" id="formulario">
        <div><p className="eyebrow light">Triagem inicial</p><h2>Conte brevemente em qual situação você se encontra</h2><p>Preencha somente as informações iniciais. Os detalhes sensíveis devem ser tratados diretamente durante o atendimento.</p></div>
        <div className="fraud-screening-card"><AccountCampaignForm /></div>
      </section>

      <section className="campaign-v2-final"><p className="eyebrow light">Não ignore prazos</p><h2>Recebeu uma intimação ou descobriu que sua conta foi envolvida em um golpe?</h2><p>Não ignore prazos nem apresente explicações sem compreender sua situação jurídica.</p><a className="button button-gold" href="#formulario">Quero solicitar atendimento</a><small>O envio das informações não garante contratação ou resultado. Cada caso depende da análise individual dos fatos, documentos e provas.</small></section>
